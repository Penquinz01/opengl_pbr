...
int start()
{
  ...
  // --------------------
  SDL_Window* window = SDL_CreateWindow("Materials",SCR_WIDTH,SCR_HEIGHT,SDL_WINDOW_OPENGL|SDL_WINDOW_RESIZABLE);
  if (window == NULL)
  {
  ...
  // ------------------------------------
  Shader lightingShader("shaders/Materials/3.1.materials.vs", "shaders/Materials/3.1.materials.fs");
  Shader lightCubeShader("shaders/Materials/3.1.light_cube.vs", "shaders/Materials/3.1.light_cube.fs");
